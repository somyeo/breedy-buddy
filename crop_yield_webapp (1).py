...
if __name__ == "__main__":
    ...
    # 사용자 입력
    Area = st.text_input("Area", value="Lesotho")
    Item = st.selectbox("Item", ['Rice, paddy', 'Wheat', 'Sorghum', 'Potatoes', 'Sweet potatoes', 'Maize', 'Soybeans', 'Cassava', 'Plantains and others', 'Yams'], index=8)
    hghayield = st.number_input("hg_ha_yield", value=31158)
    averagerainfallmmperyear = st.number_input("average_rain_fall_mm_per_year", value=1083.0)
    pesticidestonnes = st.number_input("pesticides_tonnes", value=43720.04)
